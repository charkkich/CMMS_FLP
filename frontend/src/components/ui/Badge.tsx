...
type RequestStatus = 'Submitted' | 'Approved' | 'Rejected' | 'Converted to Work Order';
type WorkOrderStatus = 'Open' | 'In Progress' | 'Waiting Spare Part' | 'Completed' | 'Closed';
...
const requestStatusColors: Record<RequestStatus, string> = {
  ...
  'Converted to Work Order': 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300',
};
